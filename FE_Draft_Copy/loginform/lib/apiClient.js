...
// 1. Config URL
const apiURL = process.env.NEXT_PUBLIC_API_URL || "https://cb-gift-app-xsgw5.ondigitalocean.app";
...
apiClient.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (!originalRequest || originalRequest.url.includes("/auth/login") || originalRequest.url.includes("/auth/refresh-token")) {
