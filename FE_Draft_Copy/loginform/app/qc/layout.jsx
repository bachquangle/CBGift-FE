...
// Import các component Layout chung của QC (nếu có)
// Ví dụ: import QcHeader from "@/components/layout/qc/header";
// import QcSidebar from "@/components/layout/qc/sidebar";

// 1. CHỈ ĐỊNH CÁC VAI TRÒ ĐƯỢC PHÉP
// Chỉ cho phép role "QC" truy cập các route này
const ALLOWED_ROLES = ["QC"];
...
export default function QcLayout({ children }) {
  ...
  return (
    // Đây là cấu trúc Layout chung của QC
