...
import { 
    ...
    ChevronRight, 
    LayoutDashboard, 
    CheckCircle2, // Icon phù hợp cho Check Product/QC
    ClipboardList // Icon thay thế cho Dashboard
...
export default function QcSidebar({ currentPage, setCurrentPage }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Tiêu đề */}
        {!isCollapsed && <h1 className="text-xl font-bold text-indigo-900 whitespace-nowrap">CNC - QC</h1>}
